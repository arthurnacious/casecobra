...
import { ArrowRight, Check, Star, Verified } from "lucide-react";
    ...
    <div className="bg-slate-50">
            ...
            <div className="flex- flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  the design. Had the case for two and half month now and{" "}
                  <span className="p-0.5 bg-slate-800 text-white">
                    the image is super clear
                  </span>
                  , on th ecase I had before, the image started fading into a
                  yellow-is color after a couple of weeks, love it&ldquo;
                </p>
              </div>
              <div className="flex gap-4 mt-2">
                ...
                <div className="flex flex-col">
                  <p className="font-semibold">Donathan</p>
                  <div className="flex gap-1.5 items-center text-zinc-600">
                    <Verified className="h-4 w-4 stroke[3px] text-green-600" />
            ...
            <div className="flex- flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  pocket, that led to some pretty heavy scratchmarks on all my
                  last phone cases. THis one besides a bearly noticeable scratch
                  on the corner{" "}
                  <span className="p-0.5 bg-slate-800 text-white">
                    Looks brand new after about half a year of use
                  </span>
                  .I dig it.&ldquo;
                </p>
              </div>
      ...
      <section>
        <MaxWidthWrapper className="py-24">
          <div className="mb-12 px-6 lg:lg:px-8">
            ...
            <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
              ...
              <div className="relative h-80 md:h-full w-full md:justify-self-end max-w-sm rounded-xl bg-gray-100/5 ring-inset ring-gray-900/10 lg:rounded-2xl">
                <Image
                  ...
                  height={500}
                  alt="Horse"
                  className="rounded-md object-cover bg-white shgadow-2xl ring-1 ring-gray-100/10 h-full w-full"
                />
              </div>
          ...
          <ul className="mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit">
            ...
            <li className="w-fit">
              <Check className="h-5 w-5 text-green-600 inline mr-1.5" />
              Scratch and fingerpring coating
            </li>
            <li className="w-fit">
              <Check className="h-5 w-5 text-green-600 inline mr-1.5" />
